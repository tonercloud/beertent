...
Item {
    ...
    // property int buttonWidth: width / 15 - buttongrid.spacing
    ...
    Column {
        ...
        PanelButton {
            ...
            Image {
                source: "../AdaptiveSearch/gfx/left.png"
        ...
        PanelButton {
            ...
            Image {
                source: "../AdaptiveSearch/gfx/down.png"
                anchors.centerIn: parent
            }
        }
    }
    ...
    Grid {
        ...
        Repeater {
            ...
            BorderImage {
                ...
                source: filterbuttonarea.pressed ? "../AdaptiveSearch/gfx/button_pressed.png" : "../AdaptiveSearch/gfx/button.png"
