...
Page {
    ...
    //      b) is easier to use than a search dialog
    ...
    InitialCharacterPicker {
        ...
        initialCharacter: ""
        caseSensitive: false
        charactersPerRow: page.width > page.height ? 9 : 5
        ...
        characters: buildCharacters(displayNumerals, displayChars);

        function buildCharacters(displayNumerals, displayChars) {
            var ret = [];
            if (displayChars) {
