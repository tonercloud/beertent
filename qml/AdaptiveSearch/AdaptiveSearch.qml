...
Item {
    ...
    Image {
        id: searchicon
        source: searchiconarea.pressed ? "../AdaptiveSearch/gfx/search_pressed.png" : "../AdaptiveSearch/gfx/search.png"
        ...
        Image {
            source: "../AdaptiveSearch/gfx/filterset.png"
    ...
    AdaptiveSearchPanel {
        ...
        onFilterUpdated: {
            ...
            // console.log("AdaptiveSearch adaptiveroot", adaptiveroot);
        }
    }
